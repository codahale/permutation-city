...
TEXT ·f1600(SB), $200-8
	...
	KECCAK_ROUND(DI, SP, $0x0000000000000001)
	KECCAK_ROUND(SP, DI, $0x0000000000008082)
	KECCAK_ROUND(DI, SP, $0x800000000000808a)
	KECCAK_ROUND(SP, DI, $0x8000000080008000)
	KECCAK_ROUND(DI, SP, $0x000000000000808b)
	KECCAK_ROUND(SP, DI, $0x0000000080000001)
	KECCAK_ROUND(DI, SP, $0x8000000080008081)
	KECCAK_ROUND(SP, DI, $0x8000000000008009)
	KECCAK_ROUND(DI, SP, $0x000000000000008a)
	KECCAK_ROUND(SP, DI, $0x0000000000000088)
	KECCAK_ROUND(DI, SP, $0x0000000080008009)
	KECCAK_ROUND(SP, DI, $0x000000008000000a)
